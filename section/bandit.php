...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="css/bandit_reset.css" />
        <link type="text/css" rel="stylesheet" href="css/bandit_slot.css" />
    ...
    <body>
        <div id="viewport">
            <div id="container">
                <br>
                <div id="header">
                    <h1><?php T("automat_slot_machine") ?></h1>
                </div>
                <br>
                <div id="reels">
                    <canvas class="canvas" id="canvas1" width="70" height="300"></canvas>
                    <canvas class="canvas" id="canvas2" width="70" height="300"></canvas>
                    <canvas class="canvas" id="canvas3" width="70" height="300"></canvas>
                    <div id="overlay">
                        <div id="winline"></div>
                    </div>
                    <div id="results">
                        <div id="score">
                            <span id="multiplier">0</span> x <img src="img/bandit/gold-64.png"/>
                        </div>
                        <div id="status"></div>
                    </div>
                </div>
                <div id="header">
                    <h3 id="playwithme"><?php T("automat_play_with_me") ?></h3>
                </div>
                <div id="buttons">
                    <div id="play" class="button button-default"><?php T("automat_play") ?></div>	 
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            var RUNTIME = 100; // how long all slots spin before starting countdown
            ...
            var BLURB_TBL = [
                '<?php T("automat_no_win") ?>',
                '<?php T("automat_win1") ?>',
                '<?php T("automat_win2") ?>',
                '<?php T("automat_winjackpot") ?>!'
            ];
            ...
            function preloadImages(images, callback) {
                ...
                function _preload(asset) {
                    asset.img = new Image();
                    asset.img.src = 'img/bandit/' + asset.id + '.png';
            ...
            function SlotGame() {
                ...
                $('#play').click(function (e) {
                    ...
                    $('#playwithme').text('<?php T("automat_rolling") ?>');
                    game.restart();
                });
            ...
            Game.prototype.update = function () {
                ...
                switch (this.state) {
                    ...
                    case 6: // check results
                        ...
                        $('#playwithme').text("<?php T("automat_try_again"); ?>");
                        this.state = 7;
                        break;
                    case 7: // game ends
                        break;
